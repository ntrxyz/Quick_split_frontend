  ...
  const fetchUserData = async (id) => {
    try {
      ...
      setFormData({
        ...
        password: "**********",
        // If your backend supplies these, use them; otherwise, default values are used.
        currency: userData.currency || "USD ($)",
        timezone: userData.timezone || "GMT+05:30 Chennai",
  ...
  const handleDeleteClick = async () => {
    ...
    if (confirmDelete) {
      try {
        ...
        // Allow the toast to display before redirecting
        setTimeout(() => {
        ...
        <div className="profile-box">
          <div className="profile-left">
            ...
            <div className="input-box">
              ...
              <button
                onClick={() =>
                  editMode.name ? handleSaveClick("name") : handleEditClick("name")
                }
              >
            ...
            <div className="input-box">
              ...
              <button
                onClick={() =>
                  editMode.email ? handleSaveClick("email") : handleEditClick("email")
                }
              >
